...
const ProductSinglePage = () => {
  ...
  return (
    <main className='py-5 bg-lightgray'>
              ...
              <div className='product-details font-manrope'>
                ...
                <div className='info flex align-center flex-wrap fs-14'>
                  <div className='rating'>
                    <span className='text-black fw-6'>Rating:</span>
                  ...
                  <div className='brand'>
                    <span className='text-black fw-5'>Brand:</span>
                    <span className='mx-1 text-gray'>{product?.brand}</span>
                  </div>
                  <div className='vert-line'></div>
                  <div className='brand'>
                    <span className='text-black fw-5'>Category:</span>
                    <span className='mx-1 text-capitalize text-gray'>
                ...
                <div className = "price">
                  ...
                  <div className='flex align-center my-1'>
                    ...
                    <div className='discount bg-gray fs-13 text-white fw-6 font-poppins'>
